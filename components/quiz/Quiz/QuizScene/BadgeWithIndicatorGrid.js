...
export class BadgeWithIndicatorGrid extends QuizScene {
    get childComponentTemplate() { console.log('this.maxSelectedCards is ', this.maxSelectedCards); return TemplateProvider.findTemplateByName(this.maxSelectedCards > 1 ? 'badge-with-check-indicator' : 'badge-with-radio-indicator'); }
